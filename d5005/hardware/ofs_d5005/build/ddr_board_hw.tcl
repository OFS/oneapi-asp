...
proc compose { } {
  ...
  add_instance ddr_channel_c ddr_channel 23.2
  add_instance ddr_channel_d ddr_channel 23.2

  add_instance acl_memory_bank_divider acl_memory_bank_divider 21.3
  set_instance_parameter_value acl_memory_bank_divider {NUM_BANKS} {4}
  ...
  set_instance_parameter_value acl_memory_bank_divider {ADDRESS_WIDTH} {35}
  ...
  set_instance_parameter_value acl_memory_bank_divider {SYNCHRONIZE_RESET} {0}
  ...
  set_instance_parameter_value dma_localmem_rd_pipe {ADDRESS_WIDTH} {35}
  ...
  set_instance_parameter_value dma_localmem_wr_pipe {ADDRESS_WIDTH} {35}
  ...
  set_instance_parameter_value dma_localmem_wr_pipe {MAX_PENDING_RESPONSES} {64}
  ...
  add_connection host_clk.out_clk ddr_channel_c.host_clk clock
  add_connection host_clk.out_clk ddr_channel_d.host_clk clock
  ...
  add_connection kernel_clk.out_clk ddr_channel_c.kernel_clk clock
  add_connection kernel_clk.out_clk ddr_channel_d.kernel_clk clock
  ...
  add_connection ddr_clk_c.out_clk ddr_channel_c.ddr_clk clock
  add_connection ddr_clk_d.out_clk ddr_channel_d.ddr_clk clock
  ...
  add_connection global_reset.out_reset_3 ddr_channel_c.global_reset reset
  add_connection global_reset.out_reset_4 ddr_channel_d.global_reset reset
  add_connection kernel_reset.out_reset acl_memory_bank_divider.kernel_reset reset

  # Data
  add_connection dma_localmem_wr_pipe.m0 acl_memory_bank_divider.s avalon
  set_connection_parameter_value dma_localmem_wr_pipe.m0/acl_memory_bank_divider.s arbitrationPriority {1}
  set_connection_parameter_value dma_localmem_wr_pipe.m0/acl_memory_bank_divider.s baseAddress {0x0}
  set_connection_parameter_value dma_localmem_wr_pipe.m0/acl_memory_bank_divider.s defaultConnection {0}

  add_connection dma_localmem_rd_pipe.m0 acl_memory_bank_divider.s avalon
  set_connection_parameter_value dma_localmem_rd_pipe.m0/acl_memory_bank_divider.s arbitrationPriority {1}
  set_connection_parameter_value dma_localmem_rd_pipe.m0/acl_memory_bank_divider.s baseAddress {0x0}
  set_connection_parameter_value dma_localmem_rd_pipe.m0/acl_memory_bank_divider.s defaultConnection {0}
  ...
  add_connection acl_memory_bank_divider.bank3 ddr_channel_c.ddr4_pipe_to_bankdiv avalon
  set_connection_parameter_value acl_memory_bank_divider.bank3/ddr_channel_c.ddr4_pipe_to_bankdiv arbitrationPriority {1}
  set_connection_parameter_value acl_memory_bank_divider.bank3/ddr_channel_c.ddr4_pipe_to_bankdiv baseAddress {0x0}
  set_connection_parameter_value acl_memory_bank_divider.bank3/ddr_channel_c.ddr4_pipe_to_bankdiv defaultConnection {0}

  add_connection acl_memory_bank_divider.bank4 ddr_channel_d.ddr4_pipe_to_bankdiv avalon
  set_connection_parameter_value acl_memory_bank_divider.bank4/ddr_channel_d.ddr4_pipe_to_bankdiv arbitrationPriority {1}
  set_connection_parameter_value acl_memory_bank_divider.bank4/ddr_channel_d.ddr4_pipe_to_bankdiv baseAddress {0x0}
  set_connection_parameter_value acl_memory_bank_divider.bank4/ddr_channel_d.ddr4_pipe_to_bankdiv defaultConnection {0}
  ...
  set_interface_property emif_ddr4c EXPORT_OF ddr_channel_c.ddr4_emif
  add_interface kernel_ddr4c avalon slave
  set_interface_property kernel_ddr4c EXPORT_OF ddr_channel_c.kernel_ddr4
  add_interface emif_ddr4d avalon master
  set_interface_property emif_ddr4d EXPORT_OF ddr_channel_d.ddr4_emif
  add_interface kernel_ddr4d avalon slave
  set_interface_property kernel_ddr4d EXPORT_OF ddr_channel_d.kernel_ddr4
  add_interface acl_bsp_snoop avalon_streaming start 
  set_interface_property acl_bsp_snoop EXPORT_OF acl_memory_bank_divider.acl_bsp_snoop
