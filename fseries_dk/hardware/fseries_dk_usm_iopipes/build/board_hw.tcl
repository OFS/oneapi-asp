...
proc compose { } {
  ...
  add_instance kernel_interface_agilex kernel_interface_agilex 17.1
  set_instance_parameter_value kernel_interface_agilex {NUM_GLOBAL_MEMS} {1}
  ...
  set_instance_parameter_value board_afu_id_avmm_slave {AFU_ID_H} {0x51ed2f4afea24261}
  set_instance_parameter_value board_afu_id_avmm_slave {AFU_ID_L} {0xa595918500575509}
  ...
  add_connection clk_200.out_clk kernel_interface_agilex.clk clock
  ...
  add_connection kernel_clk_in.out_clk kernel_interface_agilex.kernel_clk clock
  ...
  add_connection global_reset_in.out_reset kernel_interface_agilex.reset reset
  add_connection global_reset_in.out_reset kernel_interface_agilex.sw_reset_in reset
  ...
  add_connection kernel_interface_agilex.kernel_reset kernel_clk_export.clk_in_reset reset
  add_connection kernel_interface_agilex.kernel_reset ddr_board.kernel_reset reset
  add_connection board_kernel_cra_reset.out_reset board_kernel_cra_pipe.reset reset

  # IRQs
  add_connection board_irq_ctrl.interrupt_receiver kernel_interface_agilex.kernel_irq_to_host irq

  # Conduits
  add_connection kernel_interface_agilex.acl_bsp_memorg_host0x018 ddr_board.acl_bsp_memorg_host conduit
  ...
  add_connection pipe_stage_host_ctrl.m0 kernel_interface_agilex.ctrl avalon
  set_connection_parameter_value pipe_stage_host_ctrl.m0/kernel_interface_agilex.ctrl arbitrationPriority {1}
  set_connection_parameter_value pipe_stage_host_ctrl.m0/kernel_interface_agilex.ctrl baseAddress {0x4000}
  set_connection_parameter_value pipe_stage_host_ctrl.m0/kernel_interface_agilex.ctrl defaultConnection {0}
  ...
  add_connection kernel_interface_agilex.kernel_cra board_kernel_cra_pipe.s0 avalon
  set_connection_parameter_value kernel_interface_agilex.kernel_cra/board_kernel_cra_pipe.s0 arbitrationPriority {1}
  set_connection_parameter_value kernel_interface_agilex.kernel_cra/board_kernel_cra_pipe.s0 baseAddress {0x0}
  set_connection_parameter_value kernel_interface_agilex.kernel_cra/board_kernel_cra_pipe.s0 defaultConnection {0}
  ...
  set_interface_property kernel_irq EXPORT_OF kernel_interface_agilex.kernel_irq_from_kernel
