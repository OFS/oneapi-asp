...
# | parameters
# |
add_parameter AFU_ID_H STD_LOGIC_VECTOR {0x5d9fef7bc4914dce}
set_parameter_property AFU_ID_H DEFAULT_VALUE {0x5d9fef7bc4914dce}
set_parameter_property AFU_ID_H DISPLAY_NAME "AFU ID H"
set_parameter_property AFU_ID_H AFFECTS_ELABORATION true
 
add_parameter AFU_ID_L STD_LOGIC_VECTOR {0x95fcf979f6f061be}
set_parameter_property AFU_ID_L DEFAULT_VALUE {0x95fcf979f6f061be}
