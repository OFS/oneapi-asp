...
proc compose { } {
  ...
  set_instance_parameter_value ddr4_emif_pipe {ADDRESS_WIDTH} {32}
  ...
  set_instance_parameter_value ddr4_cross_to_kernel {ADDRESS_WIDTH} {32}
  ...
  set_instance_parameter_value ddr4_pipe_to_kernel {ADDRESS_WIDTH} {32}
  ...
  set_instance_parameter_value ddr4_cross_to_host {ADDRESS_WIDTH} {32}
