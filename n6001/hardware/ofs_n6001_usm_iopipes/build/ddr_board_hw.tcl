...
proc compose { } {
  ...
  set_instance_parameter_value acl_memory_bank_divider {NUM_BANKS} $number_of_memory_banks
  ...
  set_instance_parameter_value acl_memory_bank_divider {ADDRESS_WIDTH} $total_address_width
  ...
  for { set i 0} { $i < $number_of_memory_banks } {incr i} {
    set j [expr $i + 1]
    add_connection acl_memory_bank_divider.bank$j ddr_channel$i.ddr4_pipe_to_bankdiv avalon
    set_connection_parameter_value acl_memory_bank_divider.bank$j/ddr_channel$i.ddr4_pipe_to_bankdiv arbitrationPriority {1}
    set_connection_parameter_value acl_memory_bank_divider.bank$j/ddr_channel$i.ddr4_pipe_to_bankdiv baseAddress {0x0}
    set_connection_parameter_value acl_memory_bank_divider.bank$j/ddr_channel$i.ddr4_pipe_to_bankdiv defaultConnection {0}
  }
