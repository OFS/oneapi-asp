...
# ----------------------------------------
# If pcie_ss is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.1 115 linux 2023.05.15.22:38:47
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pcie_ss.pcie_ss"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [pcie_ss::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [pcie_ss::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [pcie_ss::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [pcie_ss::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [pcie_ss::normalize_path "$file"]
  set normalized_dest [pcie_ss::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [pcie_ss::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [pcie_ss::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [pcie_ss::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
